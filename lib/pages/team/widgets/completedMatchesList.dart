...
class _CompletedMatchesListState extends State<CompletedMatchesList> {
  ...
  final Matchservice _matchservice = Matchservice(); // Matchservice 인스턴스 생성
  ...
  Future<List<Map<String, dynamic>>> _fetchMatches() async {
    try {
      // Matchservice를 사용하여 완료된 경기 데이터 가져오기
      return await _matchservice.fetchCompletedMatchesByTeam(widget.teamId);
    } catch (e) {
